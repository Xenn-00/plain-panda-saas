...
export const EmptyCategoryState = ({
  ...
  return (
    <Card
      contentClassname="max-w-2xl w-full flex flex-col item-center p-6"
      className="flex flex-1 items-center justify-center"
    >
      <h2 className="text-center text-xl/8 font-medium tracking-tight text-gray-900">
        Create your first {categoryName} event
      </h2>
      <p className="mb-8 max-w-md text-pretty text-center text-sm/6 text-gray-600">
        Get started by sending a request to your tracking API:
      </p>
      <div className="w-full max-w-3xl overflow-hidden rounded-lg bg-white shadow-lg">
        <div className="flex items-center justify-between bg-gray-800 px-4 py-2">
          ...
          <span className="text-sm text-gray-400">your-first-event.ts</span>
        </div>
        <SyntaxHighlighter
          language="typescript"
          style={oneDark}
