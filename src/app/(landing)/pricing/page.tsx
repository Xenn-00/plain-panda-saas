      ...
      <MaxWidthWrapper>
        <div className="mx-auto flex max-w-2xl flex-col items-center justify-center">
          ...
          <p className="mt-6 max-w-prose text-pretty text-center text-base/7 text-gray-600">
            ...
            offer lifetime access to PlainPanda for a one-time payment
          </p>
        </div>
        <div className="mx-auto mt-16 max-w-2xl rounded-3xl bg-white ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
          <div className="p-8 sm:p-10 lg:flex-auto">
            ...
            <p className="mt-6 text-base/7 text-gray-600">
              Invest once in PlainPanda and transform how you monitor your SaaS
              forever. Get instant alerts, track critival metrics and never a
