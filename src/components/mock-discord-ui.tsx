      ...
      <div className="hidden w-60 flex-col bg-[#2f3136] lg:flex">
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          <div className="mb-4 px-2">
            <div className="hover:#393c43 flex cursor-not-allowed items-center rounded px-2 py-1.5 text-sm text-[#dcddde]">
          ...
          <div className="mb-4 px-2">
            ...
            <div className="my-1 space-y-px">
              {[...Array(4)].map((_, i) => (
                ...
                >
                  <div className="mr-3 size-6 rounded-full bg-discord-background" />
        ...
        <div className="flex items-center bg-[#292b2f] p-2">
          <div className="mr-2 size-6 rounded-full bg-brand-700" />
