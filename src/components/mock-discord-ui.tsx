      ...
      <div className="hidden lg:flex w-60 bg-[#2f3136] flex-col">
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          <div className="px-2 mb-4">
            <div className="flex items-center text-sm px-2 py-1.5 rounded hover:#393c43 text-[#dcddde] cursor-not-allowed">
              <UserCircle className="mr-4 size-6 text-[#b9bbbe]" />
              <span className="font-medium text-sm">Friends</span>
            </div>
            <div className="flex items-center text-sm px-2 py-1.5 rounded hover:#393c43 text-[#dcddde] cursor-not-allowed">
              <InboxIcon className="mr-4 size-6 text-[#b9bbbe]" />
              <span className="font-medium text-sm">Nitro</span>
            </div>
          </div>
          <div className="px-2 mb-4">
            <h3 className="text-xs font-semibold text-[#8e9297] mb-2 px-2 uppercase">
              Direct Messages
            </h3>
            <div className="flex items-center px-2 py-1.5 rounded bg-[#393c43] text-white cursor-pointer">
              <Image
                src="/brand-asset-profile-picture.png"
                alt="PlainPanda Avatar"
                width={32}
                height={32}
                className="object-cover rounded-full mr-3"
              />
              <span className="font-medium">PlainPanda</span>
            </div>
            <div className="my-1 space-y-px">
              {[...Array(4)].map((_, i) => (
                ...
                >
                  <div className="size-6 rounded-full bg-discord-background mr-3" />
        ...
        <div className="p-2 bg-[#292b2f] flex items-center">
          <div className="size-6 rounded-full bg-brand-700 mr-2" />
          ...
          <div className="flex items-center space-x-2">
            <Mic className="size-5 text-[#b9bbbe] hover:text-white" />
            <Headphones className="size-5 text-[#b9bbbe] hover:text-white" />
            <Cog className="size-5 text-[#b9bbbe] hover:text-white" />
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col">
        <div className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225]">
          ...
          <div className="flex items-center">
            ...
            <p className="font-semibold text-white">PlainPanda</p>
          </div>
        ...
        <div className="p-4">
          <div className="flex items-center bg-[#40444b] rounded-lg p-1">
            ...
            <input
              readOnly
              type="text"
              placeholder="Message @PlainPanda"
